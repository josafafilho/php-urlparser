...
class Url implements UrlInterface {
	 ...
	 */
	public function __construct( SchemeInterface $scheme, AuthenticationInterface $auth, HostInterface $host, PathInterface $path, QueryInterface $query, FragmentInterface $fragment ) {
		$this->scheme   = $scheme;
		$this->auth     = $auth;
		$this->host     = $host;
		$this->path     = $path;
